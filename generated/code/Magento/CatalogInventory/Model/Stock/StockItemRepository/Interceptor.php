...
class Interceptor extends \Magento\CatalogInventory\Model\Stock\StockItemRepository implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($stockConfiguration, $stockStateProvider, $resource, $stockItemFactory, $stockItemCollectionFactory, $productFactory, $queryBuilderFactory, $mapperFactory, $localeDate, $indexProcessor, $dateTime, $productCollectionFactory, $psrLogger);
    }
