...
class Interceptor extends \WeltPixel\OwlCarouselSlider\Controller\Adminhtml\Slider\Index implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $coreRegistry, $fileFactory, $resultPageFactory, $resultLayoutFactory, $resultForwardFactory, $jsHelper, $bannerFactory, $sliderFactory, $bannerCollectionFactory, $sliderCollectionFactory, $serializer);
    }
