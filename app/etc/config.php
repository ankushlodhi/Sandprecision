...
return [
    'modules' => [
        ...
        'Icecube_Attachment' => 1,
        'Icecube_Captcha' => 1,
        'Icecube_Catalog' => 1,
        'Icecube_Custom' => 1,
        'Icecube_Customtab' => 0,
        'Icecube_Galleryslider' => 1,
        'Icecube_Mailsubject' => 1,
        'Icecube_SpamSearch' => 1,
        'Icecube_SpecialOffers' => 1,
        'Icecube_Subcategories' => 1,
        'Icecube_UrlRewrite' => 0,
        'Lof_NextGenImages' => 1,
        'Lof_Webp2' => 1,
